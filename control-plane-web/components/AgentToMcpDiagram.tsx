...
export function AgentToMcpDiagram() {
  return (
    <div className="relative overflow-hidden rounded-3xl border border-border bg-[#09090b] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
      ...
      <div className="relative flex items-center justify-between text-xs font-semibold uppercase tracking-[0.16em] text-muted">
        <span>Coding agent</span>
        <span>MCP bridge</span>
      </div>

      <div className="relative mt-5 aspect-[16/9] rounded-2xl border border-border bg-[radial-gradient(circle_at_30%_20%,rgba(245,166,35,0.16),transparent_30%),linear-gradient(135deg,rgba(255,255,255,0.05),rgba(255,255,255,0.01))] p-4">
        <svg viewBox="0 0 640 360" fill="none" className="h-full w-full">
          <defs>
            <linearGradient id="fh-diagram-line" x1="80" y1="174" x2="555" y2="174" gradientUnits="userSpaceOnUse">
              <stop stopColor="#f5a623" stopOpacity="0.85" />
          ...
          <g>
            <rect x="36" y="84" width="160" height="152" rx="24" fill="rgba(19,19,22,0.92)" stroke="rgba(255,255,255,0.10)" />
            <circle cx="70" cy="120" r="8" fill="#f5a623" />
            <circle cx="96" cy="120" r="8" fill="rgba(255,255,255,0.18)" />
            <circle cx="122" cy="120" r="8" fill="rgba(255,255,255,0.18)" />
            <path d="M68 162h78M68 188h96M68 214h54" stroke="rgba(245,245,240,0.66)" strokeWidth="8" strokeLinecap="round" />
            <text x="68" y="258" fill="#a3a19b" fontSize="18" fontFamily="monospace">agent asks</text>
          </g>

          <g>
            <rect x="250" y="110" width="140" height="104" rx="22" fill="rgba(245,166,35,0.12)" stroke="rgba(245,166,35,0.34)" />
            <path d="M292 160h56M320 132v56" stroke="#f5a623" strokeWidth="10" strokeLinecap="round" />
            <text x="282" y="247" fill="#f5a623" fontSize="18" fontFamily="monospace">MCP key</text>
          </g>

          <g>
            <rect x="444" y="72" width="160" height="198" rx="28" fill="rgba(19,19,22,0.92)" stroke="rgba(255,255,255,0.10)" />
            <path d="M484 126h82M484 158h60M484 190h92" stroke="rgba(245,245,240,0.66)" strokeWidth="8" strokeLinecap="round" />
          ...
          <circle cx="148" cy="178" r="8" fill="#f5a623" className="fh-pulse" />
          <circle cx="492" cy="174" r="8" fill="#4ade80" className="fh-pulse" />
        </svg>

        <span
          className="absolute left-0 top-0 h-3 w-3 rounded-full bg-accent shadow-[0_0_24px_rgba(245,166,35,0.9)]"
          style={{
      ...
      <div className="relative mt-4 grid gap-2 text-sm text-muted sm:grid-cols-3">
        <div className="rounded-2xl border border-border bg-surface/70 p-3">
          <span className="block font-semibold text-foreground">Access</span>
          Create a secure workspace token.
        </div>
        <div className="rounded-2xl border border-border bg-surface/70 p-3">
          <span className="block font-semibold text-foreground">Connect</span>
